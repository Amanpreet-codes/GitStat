...
export default function TotalRepo({ total }: TotalRepoProps) {
    return (
        <div className="p-6 max-w-xs rounded-xl bg-white dark:bg-zinc-900 shadow-xl border border-black/10 dark:border-zinc-800 aspect-square flex flex-col justify-center items-center">
