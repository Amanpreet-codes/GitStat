...
export default function TotalRepo({ total }: TotalRepoProps) {
    return (
        <div className="p-6 max-w-xs rounded-xl bg-white dark:bg-slate-950 shadow-lg border border-slate-200 dark:border-slate-800 aspect-square flex flex-col justify-center items-center">
